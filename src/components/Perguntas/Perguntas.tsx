    ...
    return (
        <section className="flex flex-col items-center w-full my-20">
            ...
            <div className="flex gap-12 m-6 mb-10 flex-wrap flex-row md:justify-around md:m-0 md:my-10 xl:gap-[6em]">
                ...
                <p className="text-sm shadow-pergunta p-4 w-11/12 bg-[#C4F9FF] text-black md:text-base md:w-2/5 lg:text-xl lg:w-80 lg:h-80"><span className="font-bold">Quais informações preciso fornecer para obter um diagnóstico preciso?</span><br /><br />
                    Descrever da maneira mais detalhada o possível o que está ocorrendo com seu automóvel</p>

                <p className="text-sm shadow-pergunta p-4 w-11/12 bg-[#CCFF99] text-black md:text-base md:w-2/5 lg:text-xl lg:w-80 lg:h-80"><span className="font-bold">Existe algum custo para usar o aplicativo?</span><br /><br />
